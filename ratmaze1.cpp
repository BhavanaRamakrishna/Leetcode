...
int main()
{
	...
	list< std::pair<int,char> > cheese;
		...
		totalmin += min;
	min = 999;
	list< std::pair<int,char> > cheese1;
		for(int i=0;i<N;i++){
			for(int j=0;j<M;j++){
				if(grid[i][j] == 2){
					cheese1.emplace_front(i,j);
				}
			}
		}
		for(auto& x:cheese1){
		...
		totalmin += min;
	min = 999;
	list< std::pair<int,char> > cheese2;
		for(int i=0;i<N;i++){
			for(int j=0;j<M;j++){
				if(grid[i][j] == 2){
					cheese2.emplace_front(i,j);
				}
			}
		}
		for(auto& x:cheese2){
		...
		totalmin += min;
	min = 999;
	list< std::pair<int,char> > cheese3;
		for(int i=0;i<N;i++){
			for(int j=0;j<M;j++){
				if(grid[i][j] == 2){
					cheese3.emplace_front(i,j);
				}
			}
		}
		for(auto& x:cheese3){
